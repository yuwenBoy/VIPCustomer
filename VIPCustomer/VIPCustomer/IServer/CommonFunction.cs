...
namespace VIPCustomer23333.IServer
{
    public class CommonFunction
    {
        ...
        public static bool CheckOrderAttach(int OrderID, string configName)
        {
            ...
            Order oInfo = order.GetOrderByPKID(OrderID);
        ...
        private static IList<string> _getMatchingAttach(Order order, IList<string> orderCars, JArray jaCondation)
        {
